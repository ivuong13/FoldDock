...
def marks_box(marks_dockq_AF, marks_dockq_GRAMM, marks_dockq_mdockpp, marks_dockq_TMfull, marks_dockq_TMint, marks_dockq_RF,outdir):
    ...
    data3 = [mdockpp_scores, af2_std_scores,  paired_scores, top_paired_af_scores, top_paired_fused_scores]
    ...
    xlabels3 = ['MDockPP', 'AF2', 'Paired', 'AF2+Paired\ntop ranked','Block+Paired\ntop ranked']
    all_xlabels = [xlabels1, xlabels2, xlabels3]

    #Color
    colors = sns.husl_palette(len(xlabels1)+2)
    all_colors = [colors[:len(xlabels1)],colors[-len(xlabels2):],colors[-len(xlabels3):]]
